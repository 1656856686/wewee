   ...
   private  Integer ps_getpeople;
    ...
    public String toString() {
        return "Projects{" +
                "ps_id=" + ps_id +
                ", ps_us_id=" + ps_us_id +
                ", ps_cust_name='" + ps_cust_name + '\'' +
                ", ps_cust_phone='" + ps_cust_phone + '\'' +
                ...
                ", ps_video='" + ps_video + '\'' +
                ", ps_story='" + ps_story + '\'' +
                ", ps_support='" + ps_support + '\'' +
                ", ps_repay='" + ps_repay + '\'' +
                ", ps_aboutme='" + ps_aboutme + '\'' +
                ", ps_type=" + ps_type +
                ", ps_starttime='" + ps_starttime + '\'' +
                ", ps_endtime='" + ps_endtime + '\'' +
                ", ps_getmoney=" + ps_getmoney +
                ", ps_getpeople=" + ps_getpeople +
                '}';
    }
